						...
						{ tabName === 'style' && (
							<>
								<BlockishControl
									...
									initialOpen={ true }
								indicatorSlugs={['iconSize', 'iconColor', 'iconHoverColor', 'iconHoverTransition']}>
								...
								<BlockishControl
									...
									initialOpen={ false }
								indicatorSlugs={['textTypography', 'textColor', 'textHoverColor', 'textHoverTransition']}>
