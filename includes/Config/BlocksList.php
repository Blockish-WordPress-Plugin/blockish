    ...
    protected function set_list() {
        $this->list = array(
            ...
            'navmenu' => array(
                ...
                'description' => __('Desktop navigation menu inside Navigation. Horizontal/vertical layout, item styling, submenuTrigger (hover|click), and submenuRevealAnimation (fade|slide|scale|soft). Children are navmenu-item blocks that may nest submenu or megamenu dropdowns.', 'blockish'),
                'package'     => 'free',
                'status'      => 'active',
                'parent'      => 'navigation',
            ),
            'navmenu-item' => array(
                ...
                'description' => __('Single nav link (label, url, optional icon). Parent: navmenu, offcanvas, or nested submenu. May contain exactly one child: navmenu-submenu (link list) or navmenu-megamenu (CPT embed) — not both.', 'blockish'),
                'package'     => 'free',
                'status'      => 'active',
                'parent'      => 'navmenu',
            ),
            'navmenu-submenu' => array(
                ...
                'description' => __('Dropdown/flyout under a navmenu-item. Nested navmenu-item children only. Controls: alignment, itemGap, positionAlign, offsetY/offsetX. Inside offcanvas sync, renders as accordion (desktop card chrome stripped).', 'blockish'),
                'package'     => 'free',
                'status'      => 'active',
                'parent'      => 'navmenu-item',
            ),
            'navmenu-megamenu' => array(
                ...
                'description' => __('Wide mega dropdown under a navmenu-item. Embeds a published blockish_megamenu CPT via megamenuId (create CPT with manage-post). Width modes: navigation|full|custom; customWidth, positionAlign, alignRelativeTo, offsetY/offsetX. Mutually exclusive with navmenu-submenu on the same item.', 'blockish'),
                'package'     => 'free',
                'status'      => 'active',
                'parent'      => 'navmenu-item',
            ),
            'offcanvas' => array(
                ...
                'description' => __('Mobile slide-in drawer + hamburger inside Navigation. syncWithMenu mirrors sibling navmenu (including submenu/megamenu trees) as accordion. Side, animation, header branding, hamburger icon. Do not put transform on the root.', 'blockish'),
                'package'     => 'free',
                'status'      => 'active',
                'parent'      => 'navigation',
            ),
