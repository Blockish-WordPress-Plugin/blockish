    ...
    protected function set_list() {
        $this->list = array(
            ...
            'form' => array(
                ...
                'description' => __('A modern, secure Form Builder wrapper. Add inputs, textareas, and submit buttons inside to create contact forms, lead generation forms, and more.', 'blockish'),
                'package'     => 'pro',
            ...
            'input' => array(
                'name'        => __('Input', 'blockish'),
                'description' => __('Text, email, number, or password input field for the form block.', 'blockish'),
                'package'     => 'pro',
                'addon'       => 'blockish-forms',
                'addon_name'  => 'Forms',
                'status'      => 'active',
