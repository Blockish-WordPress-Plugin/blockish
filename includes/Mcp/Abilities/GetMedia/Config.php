...
class Config
{
    ...
    public static function get(): array
    {
        return [
            ...
            'description'         => __('Lists existing items in the WordPress Media Library. Always call this before blockish/upload-media to check whether a suitable image already exists — avoid uploading duplicates of the same image.', 'blockish'),
            'category'            => 'blockish',
            'input_schema'        => [
                'type'       => 'object',
                'properties' => [
