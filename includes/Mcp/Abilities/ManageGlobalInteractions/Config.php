                    ...
                    'interactions' => [
                        ...
                        'items' => [
                            ...
                            'properties' => [
                                ...
                                'event' => [ 'type' => 'string', 'description' => 'DOM event, e.g., "click", "scroll"' ],
                                'selector' => [ 'type' => 'string', 'description' => 'Optional CSS selector for event delegation on document.body' ],
                                'callbacks' => [
                                    'type' => 'array',
                                    'items' => [ 'type' => 'string' ],
                                    'description' => 'Array of raw JS code strings to execute. The variables `event` and `blockElement` (document.body) are available.'
                                ]
                            ],
