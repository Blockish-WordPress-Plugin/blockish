                    ...
                    'templates' => [
                        ...
                        'items' => [
                            ...
                            'properties' => [
                                ...
                                'schema'        => ['type' => 'array', 'description' => 'The LIVE schema array parsed from content. Present only if fetched by slug.'],
                                'pending_schema'=> ['type' => 'array', 'description' => 'The PENDING schema array waiting to be reviewed in the editor. Present only if fetched by slug and if a pending schema exists.'],
                            ],
                        ],
                    ],
                    'error'     => ['type' => 'string'],
