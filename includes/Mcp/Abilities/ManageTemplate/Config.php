        ...
        return [
            ...
            'output_schema'       => [
                ...
                'properties' => [
                    ...
                    'resolve_url'   => ['type' => 'string', 'description' => 'Present when schema_staged. Editor URL with resolve query args (writes children; no frontend redirect for templates).'],
            ...
            'meta'                => [
                'mcp' => ['public' => true],
                'usage_notes' => 'Same tool on block themes (FSE) and classic + Theme Builder. FSE: core/template-part with theme slug on wp_template. Theme Builder: blockish/template-part with area or catalog slug (checkout-header, mini-cart, …). Header/footer parts: set show_on. TB template example: [{"name":"blockish/template-part","attributes":{"slug":"header"}},{"name":"blockish/container","attributes":{"tagName":{"label":"Main","value":"main"},"flexDirection":{"Desktop":"column"},"innerContentWidth":true},"innerBlocks":[{"name":"blockish/post-content","attributes":{"align":"full"}}]},{"name":"blockish/template-part","attributes":{"slug":"footer"}}]. ALWAYS trigger-refresh (numeric id) and share edit_url or resolve_url.',
            ],
        ];
    }
}
